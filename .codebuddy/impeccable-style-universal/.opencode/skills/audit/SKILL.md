...
- **Suggested command**: Which command to use (prefer: /polish, /delight, /normalize, /quieter, /typeset, /overdrive, /arrange, /harden, /adapt, /onboard, /clarify, /bolder, /optimize, /audit, /critique, /colorize, /extract, /distill, /animate — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /polish, /delight, /normalize, /quieter, /typeset, /overdrive, /arrange, /harden, /adapt, /onboard, /clarify, /bolder, /optimize, /audit, /critique, /colorize, /extract, /distill, /animate. You may also suggest other installed skills you're sure exist, but never invent commands.
