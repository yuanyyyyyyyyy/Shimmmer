...
- **Command**: Which command to use (prefer: /polish, /delight, /normalize, /quieter, /typeset, /overdrive, /arrange, /harden, /adapt, /onboard, /clarify, /bolder, /optimize, /audit, /critique, /colorize, /extract, /distill, /animate — or other installed skills you're sure exist)
